...
use Arshad\Slider\Block\Adminhtml\Slider\Edit\Tab\Render\GridImage;
use Arshad\Slider\Block\Adminhtml\Slider\Edit\Tab\Render\Status;
use Arshad\Slider\Model\BannerFactory;
use Arshad\Slider\Model\ResourceModel\Banner\Collection;
use Arshad\Slider\Model\ResourceModel\Banner\CollectionFactory as BannerCollectionFactory;
...
class Banner extends Extended implements TabInterface
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(
            ['related' => $collection->getTable('arshad_banner_slider')],
    ...
    /**
     * @param \Arshad\Slider\Model\Banner|Object $item
     *
     * @return string
     */
    ...
    /**
     * @return \Arshad\Slider\Model\Slider
     */
    public function getSlider()
    {
        return $this->coreRegistry->registry('arshadslider_slider');
    }
    ...
    {
        return $this->getUrl('arshadslider/slider/banners', ['_current' => true]);
    }
