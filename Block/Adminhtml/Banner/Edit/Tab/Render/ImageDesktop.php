...
namespace Arshad\Slider\Block\Adminhtml\Banner\Edit\Tab\Render;
...
class ImageDesktop extends \Magento\Framework\Data\Form\Element\Image
{
    /**
     * @var ImageModel
     */
    ...
    protected function _getUrl()
    {
        $url = '';
        if ($this->getValue()) {
            $url = $this->imageModel->getBaseUrl() . 'desktop/' . $this->getValue();
        }
        return $url;
    }
